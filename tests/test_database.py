    ...
    try:
        table_attributes = {
            ...
            "columns": [
                ...
                {"name": "example_text", "data_type": "text", "is_null": False},
                {
                    "name": "created_at",
...
def test_table_communication():
    ...
    try:
        ...
        for i in range(len(results1)):
            assert (
                results1[i]["example_text"] == table_rows[i]["column_data"][0]["value"]
            )
        ...
        select_attrs2 = {
            ...
            "where": [
                {"column": "created_at", "operator": "<", "value": timestamps[2]}
            ],
        }
        ...
        select_attrs3 = {
            ...
            "columns": ["example_text"],
            "where": [
                {"column": "created_at", "operator": ">", "value": timestamps[0]},
                {"column": "created_at", "operator": "<", "value": timestamps[2]},
            ],
        }
